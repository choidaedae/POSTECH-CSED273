...
REM
REM Generated by Vivado on Fri May 13 01:18:32 +0900 2022
...
echo "xvlog --incr --relax -prj lab5_1_tb_vlog.prj"
call xvlog  --incr --relax -prj lab5_1_tb_vlog.prj -log xvlog.log
